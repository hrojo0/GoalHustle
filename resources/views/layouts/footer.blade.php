                ...
                <div class="uk-width-1-1">
                    <div class="uk-panel">
                        <div class="footer-logo">
                            <a href="{{ route('welcome') }}"><img src="{{ asset('img/icono.ico') }}" alt=""><span>Goal</span>Hustle</a>
                        </div>
...
<div style="background: #22252b">
<footer id="footer" class="container version-ii">
    <div class="row">
        <div class="col-xs-12 col-sm-6">
            <p>Desarrollado por &copy; <a href="{{route('welcome')}}">Haniel Rojo</a></p>
        </div>
        <div class="col-xs-12 col-sm-6">
